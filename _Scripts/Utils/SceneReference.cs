...
public class SceneReferencePropertyDrawer : PropertyDrawer
{
    ...
    private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
    {
        ...
        {
            iconContent = EditorGUIUtility.IconContent("missing");
        ...
        {
            iconContent = EditorGUIUtility.IconContent("enabled");
        ...
        {
            iconContent = EditorGUIUtility.IconContent("disabled");
            labelContent.text = "BuildIndex: " + buildScene.buildIndex;
        ...
        {
            Debug.LogWarning("IconContent or LabelContent is null");
            return;
        }
